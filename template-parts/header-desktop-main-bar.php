...
?>
<div id="suki-header-main-bar" class="<?php echo esc_attr( implode( ' ', apply_filters( 'suki/frontend/header_main_bar_classes', array( 'suki-header-main-bar', 'suki-header-section', 'suki-section' ) ) ) ); ?>" <?php echo $attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
