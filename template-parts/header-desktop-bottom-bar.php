...
?>
<div id="suki-header-bottom-bar" class="<?php echo esc_attr( implode( ' ', apply_filters( 'suki/frontend/header_bottom_bar_classes', array( 'suki-header-bottom-bar', 'suki-header-section', 'suki-section' ) ) ) ); ?>" <?php echo $attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
