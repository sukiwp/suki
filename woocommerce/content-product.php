...
<li <?php wc_product_class( '', $product ); ?>>
	<div class="<?php echo esc_attr( implode( ' ', apply_filters( 'suki/frontend/woocommerce/loop_item_classes', array( 'suki-product-wrapper' ) ) ) ); ?>">
		 ...
		 *
		 * @hooked Suki_Compatibility_WooCommerce::render_loop_product_thumbnail_wrapper() - 1
		 ...
		 * @hooked Suki_Compatibility_WooCommerce::render_loop_product_thumbnail_wrapper_end() - 999
		 */
