	...
	new Suki_Customize_Heading_Control(
		...
		array(
			...
			'description' => sprintf(
				...
				'<a href="' . esc_attr( add_query_arg( 'autofocus[section]', 'suki_section_social', remove_query_arg( 'autofocus' ) ) ) . '" class="suki-jump-to-control-link">' . esc_html__( 'Global Configurations', 'suki' ) . '</a>'
			),
			'priority'    => 10,
		)
	)
