			...
			case 'page_header':
				...
				<div class="suki-admin-form-row">
					...
					<div class="suki-admin-form-field">
						...
						?>
						<p class="description"><?php esc_html_e( 'Default page title text is generated by native WordPress functions. Use this option to display custom page title text.', 'suki' ); ?></p>
					</div>
				</div>
