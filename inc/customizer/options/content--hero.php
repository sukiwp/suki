...
$wp_customize->add_control( new Suki_Customize_Control_Toggle( $wp_customize, $key, array(
	'section'     => $section,
	'label'       => esc_html__( 'Enable', 'suki' ) . ' <span class="suki-global-default-badge" tabindex="0" data-tooltip="' . esc_attr__( 'You can enable or disable this option on each individual page via Dynamic Page Layout settings.', 'suki-pro' ) . '"><span class="dashicons dashicons-admin-site-alt3"></span> ' . esc_html__( 'Global', 'suki-pro' ) . '</span>',
