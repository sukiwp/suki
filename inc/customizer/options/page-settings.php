...
foreach ( Suki_Customizer::instance()->get_all_page_settings_types() as $type => $type_data ) {
	...
	$wp_customize->add_control( $id, array(
		...
		'description' => esc_html__( 'Narrow content would disregard Section layout.', 'suki' ),
		'priority'    => 10,
	) );
	...
	$wp_customize->add_control( $id, array(
		...
		'description' => esc_html__( 'Default page title text is generated by native WordPress functions. Use this option to display custom page title text.', 'suki' ),
		'priority'    => 30,
	) );
