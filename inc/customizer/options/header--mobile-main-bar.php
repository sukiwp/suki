...
$colors = array(
	...
	'header_mobile_main_bar_link_text_color'       => esc_html__( 'Menu link text color', 'suki' ),
	'header_mobile_main_bar_link_hover_text_color' => esc_html__( 'Menu link text color :hover', 'suki' ),
);
