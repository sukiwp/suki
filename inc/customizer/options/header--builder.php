...
$wp_customize->add_control( new Suki_Customize_Control_Builder( $wp_customize, 'header_elements', array(
	...
	'choices'     => apply_filters( 'suki_customizer_header_elements', array(
		...
		'contact-details'    => '<span class="dashicons dashicons-id"></span>' . esc_html__( 'Contact Details', 'suki' ) . ' 1',
	) ),
	...
	'labels'      => array(
		'top_left'      => is_rtl() ? esc_html__( 'Top - Right - RTL', 'suki' ) : esc_html__( 'Top - Left', 'suki' ),
		'top_center'    => esc_html__( 'Top - Center', 'suki' ),
		'top_right'     => is_rtl() ? esc_html__( 'Top - Left - RTL', 'suki' ) : esc_html__( 'Top - Right', 'suki' ),
		'main_left'     => is_rtl() ? esc_html__( 'Main - Right - RTL', 'suki' ) : esc_html__( 'Main - Left', 'suki' ),
		'main_center'   => esc_html__( 'Main - Center', 'suki' ),
		'main_right'    => is_rtl() ? esc_html__( 'Main - Left - RTL', 'suki' ) : esc_html__( 'Main - Right', 'suki' ),
		'bottom_left'   => is_rtl() ? esc_html__( 'Bottom - Right - RTL', 'suki' ) : esc_html__( 'Bottom - Left', 'suki' ),
		'bottom_center' => esc_html__( 'Bottom - Center', 'suki' ),
		'bottom_right'  => is_rtl() ? esc_html__( 'Bottom - Left - RTL', 'suki' ) : esc_html__( 'Bottom - Right', 'suki' ),
	),
	'priority'    => 10,
) ) );
...
$wp_customize->add_control( new Suki_Customize_Control_Builder( $wp_customize, 'header_mobile_elements', array(
	...
	'labels'      => array(
		'mobile_main_left'    => is_rtl() ? esc_html__( 'Right - RTL', 'suki' ) : esc_html__( 'Left', 'suki' ),
		'mobile_main_center'  => esc_html__( 'Center', 'suki' ),
		'mobile_main_right'   => is_rtl() ? esc_html__( 'Left - RTL', 'suki' ) : esc_html__( 'Right', 'suki' ),
