...
if ( suki_show_pro_teaser() ) {
	$wp_customize->add_control( new Suki_Customize_Control_Pro( $wp_customize, 'pro_teaser_woocommerce_single_typography', array(
		'section'     => $section,
		'settings'    => array(),
		'label'       => esc_html_x( 'Price Typography', 'Suki Pro teaser', 'suki' ),
		'url'         => 'https://sukiwp.com/pro/modules/advanced-typography/',
		'priority'    => 90,
	) ) );

	$wp_customize->add_control( new Suki_Customize_Control_Pro( $wp_customize, 'pro_teaser_woocommerce_single_add_to_cart', array(
		'section'     => $section,
		'settings'    => array(),
		'label'       => esc_html_x( 'Add to Cart Models', 'Suki Pro teaser', 'suki' ),
		'url'         => 'https://sukiwp.com/pro/modules/advanced-woocommerce/',
		'priority'    => 90,
	) ) );

	$wp_customize->add_control( new Suki_Customize_Control_Pro( $wp_customize, 'pro_teaser_woocommerce_single_gallery', array(
		'section'     => $section,
		'settings'    => array(),
		'label'       => esc_html_x( 'Gallery Models', 'Suki Pro teaser', 'suki' ),
		'url'         => 'https://sukiwp.com/pro/modules/advanced-woocommerce/',
		'priority'    => 90,
	) ) );

	$wp_customize->add_control( new Suki_Customize_Control_Pro( $wp_customize, 'pro_teaser_woocommerce_single_tabs', array(
		'section'     => $section,
		'settings'    => array(),
		'label'       => esc_html_x( 'Tabs Models', 'Suki Pro teaser', 'suki' ),
		'url'         => 'https://sukiwp.com/pro/modules/advanced-woocommerce/',
		'priority'    => 90,
	) ) );
}