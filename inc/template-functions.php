...
/**
 * Implement performance optimization based on Customizer settings.
 */
function suki_performance() {
	/**
	 * Disable emoji scripts.
	 */
	if ( intval( suki_get_theme_mod( 'disable_emoji' ) ) ) {
...
add_action( 'init', 'suki_performance' );
