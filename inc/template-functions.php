...
function suki_header_mobile_vertical_classes( $classes ) {
	...
	if ( 'full-screen' === suki_get_theme_mod( 'header_mobile_vertical_bar_display' ) ) {
		$classes['position'] = esc_attr( 'suki-header-mobile-vertical-position-' . suki_get_theme_mod( 'header_mobile_vertical_bar_position_full_screen' ) );
	} else {
